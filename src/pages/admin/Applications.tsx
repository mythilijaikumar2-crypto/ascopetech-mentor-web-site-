  ...
  return (
    <div className="max-w-md flex flex-col gap-6 animate-fade-up">
      <div className="border-b border-slate-200 pb-5">
        ...
        <h1 className="text-xl font-bold text-slate-900 tracking-tight mt-1.5">Applications Monitor</h1>
      </div>
      ...
      <Card className="p-6 border-slate-200 bg-white shadow-sm flex flex-col items-center text-center gap-4">
        ...
        <div>
          <h3 className="text-sm font-bold text-slate-800">Job applications pipelines are open</h3>
          <p className="text-xs text-slate-455 mt-1">Recruiter review logs are synced in real-time. Check matching vacancy entries inside the main console.</p>
        </div>
